...
function Navlanding({}) {
  ...
  return (
    <nav className="w-full fixed">
      <div className="bg-background border-b py-5 md:py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-baseline space-x-4">
              <Link href="/about">
                <div className="text-primary hover:text-blue-900 px-3 py-2 rounded-md text-base font-medium cursor-pointer">
                  About
                </div>
              </Link>
              <Link href="/services">
            ...
            <AnimatePresence>
              {isOpen && (
                ...
                >
                  <Link href="/about">
                    <div className="text-accent px-3 py-2 rounded-md text-base font-medium cursor-pointer">
                      About
                    </div>
                  </Link>
                  <Link href="/services">
